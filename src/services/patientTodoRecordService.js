 ...
 * 依病患id及日期，取得所有病患待辦事項
 * */
exports.getPatientTodoByPatientID = function(patient_person_id,patient_todo_record_date,  callback){

    DBAgent.query("QRY_ALL_PATIENT_TODO_RECORD_BY_PATIENT_PERSION_ID",
        {patient_person_id:patient_person_id,patient_todo_record_date:patient_todo_record_date} , function(err , rows){
...
exports.countPatientTodoByDate = function(patient_person_id, patient_todo_record_date ,callback){
    ...
    DBAgent.query("QRY_PATIENT_TODO_RECORD_COUNT_BY_DATE",{todo_date:patient_todo_record_date,patient_person_id:patient_person_id} , function(err , rows){
...
exports.getPatientTodoCountByDate = function(patient_todo_record_date, ward_zone_id,callback){
    ...
    DBAgent.query("QRY_ALL_PATIENT_TODO_RECORD_COUNT_BY_DATE",{todo_date:patient_todo_record_date,ward_zone_id:ward_zone_id} , function(err , rows){
 ...
 * 批次加入病患待辦事項
 * */
exports.addPatientTodo = function(patient_todo_records,update_user, callback){
