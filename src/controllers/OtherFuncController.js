...
exports.todoPhrase = function(req, res){
    res.render("Admin/Other/todoPhrase");
};

/** 病房公告維護 **/
exports.bedAnnounceMaintain = function(req, res){
    res.render("Admin/Other/bedAnnounceMaintain");
};

/** 跑馬燈訊息維護 **/
exports.marqueeMsgMaintain = function(req, res){
    res.render("Admin/Other/marqueeMsgMaintain");
};

/** 班別時段設定 **/
exports.shiftTimePeriodSet = function(req, res){
    res.render("Admin/Other/shiftTimePeriodSet");
};

/** 醫師別維護 **/
exports.doctorClassMaintain = function(req, res){
    res.render("Admin/Other/doctorClassMaintain");
};

/** 通聯記錄查詢 **/
exports.communiRecord = function(req, res){
    res.render("Admin/Other/communiRecord");
};

/** 消防記錄維護**/
exports.firemissionMaintain = function(req, res){
    res.render("Admin/Other/firemissionMaintain");
};
