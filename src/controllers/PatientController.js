...
//出院備註
var patientDischargedRemarkService = require("../services/patientDischargedRemarkService");


//過敏資料
var patientAllergyService = require("../services/patientAllergyService");


//醫囑資料
var patientMedicalInformationService = require("../services/patientMedicalInformationService");
...
//    }
    ...
    try{
            ...
            patientTodoRecordService.addPatientTodo(patient_todo_records,update_user,
                function(result,errorCode){
...
exports.patientTodoItem = function(req, res){
    res.render("Patient/patientTodoItem")
};

/**
 *病人出院備住設定畫面
 * **/
exports.patientDischargedNoteSet = function(req, res){
    res.render("Patient/patientDischargedNoteSet")
};
